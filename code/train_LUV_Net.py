...
def parse_args():
    ...
    parser.add_argument('--seed_num', type=int, default=34,help='seed_num')
    ...
    parser.add_argument('--save_path', type=str, default='/data2/hoon2/Results/video_model2/',help='save_path')
    ...
    parser.add_argument('--total_epochs', type=int, default=150, help='the number of training epochs.')
    parser.add_argument('--stop_patience_num', type=int, default=20, help='the number of training epochs.')
...
def train():
    ...
    wandb.run.name = f'seed_{args.seed_num}_test{args.model_test_rate}_{args.version}_{args.model_name}_lr{args.lr}_{args.encoder_name}_{args.task}_{args.model_output_class}_artifacts_{args.frame_size}_duplicate_{args.batch_size*args.accumulation_steps}batch_{args.pooling_method}_{args.num_heads}head_{args.kernel_width}ksize_fold{args.fold_num}_{args.train_layer}_train'
    wandb.run.save()
    ...
    if args.model_name == 'LUV_Net' or args.model_name == 'LUV_Net_TFWO':
        # dataloader
