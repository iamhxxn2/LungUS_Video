...
class video_dataset(Dataset):
    ...
    def __init__(self, csv_path, transforms, is_train=True): 
        ...
        self.video_path_list = [str(i) for i in self.video_df['clip_path']] 
        self.label_list = [int(i) for i in self.video_df['Lung ultrasound score_lbl']] 
