...
def parse_args():
    ...
    # model 
    parser.add_argument('--model_name', type=str, default='LUV_Net',help='model')
    ...
    parser.add_argument('--save_path', type=str, default='/home/work/LUS/Results/video_model/',help='save_path')
...
def train():
    ...
    wandb.init(project='LUS_video_test', config=config)
    if args.model_name == 'LUV_Net':
        wandb.run.name = f'seed_{args.seed_num}_test{args.model_test_rate}_{args.data_type}_{args.version}_{args.model_name}_lr{args.lr}_{args.encoder_name}_{args.encoder_batch_size}_{args.task}_{args.model_output_class}_artifacts_{args.frame_size}_duplicate_{args.batch_size*args.accumulation_steps}batch_{args.pooling_method}_{args.num_heads}head_{args.kernel_width}ksize_fold{args.fold_num}_{args.train_layer}_train'
        wandb.run.save()
    else:
    ...
    if args.model_name == 'LUV_Net' or args.model_name == 'LUV_Net_' or args.model_name == 'USVN':
        # dataloader
    ...
    elif args.model_name == 'CNNLSTM' or args.model_name == 'C3D' or args.model_name == 'R2Plus1D':
    ...
    if args.model_name == "LUV_Net":
        ...
        num_frames = [30]*args.batch_size
        model = LUV_Net_(encoder, args.num_heads, pooling_method = args.pooling_method)
...
#             print(train_labels.shape)
            ...
            if args.model_name == 'USVN' or args.model_name == 'LUV_Net' or args.model_name == 'LUV_Net_':
...
#                 best_thresholds = current_thresholds
                ...
                if args.model_name == "LUV_Net":        
                    checkpoint3(args.seed_num, args.batch_size*args.accumulation_steps, args.version, args.frame_size, 
                            ...
                            args.encoder_name, args.encoder_batch_size, 
                ...
                elif args.model_name == "USVN" or args.model_name == "LUV_Net_":
                    checkpoint2(args.seed_num, args.batch_size*args.accumulation_steps, args.version, args.frame_size, 
                            args.data_type, args.train_layer, args.model_test_rate, checkpoint_std_loss, 
                            model, args.model_output_class, args.save_path, args.model_name, 
                            args.encoder_name, args.encoder_batch_size, 
                    ...
                    checkpoint(args.seed_num, args.batch_size*args.accumulation_steps, args.version, args.frame_size, 
                            args.data_type, args.train_layer, args.model_test_rate, checkpoint_std_loss, 
                            model, args.model_output_class, args.save_path, args.model_name, 
                            args.fold_num, args.lr,
                            best_epoch, best_valid_loss, best_valid_acc, 
                            best_valid_auc, best_thresholds)
