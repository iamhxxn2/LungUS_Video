...
def train():
    ...
    wandb.run.name = f'seed_{args.seed_num}_test{args.model_test_rate}_{args.version}_clip{args.frame_num}_{args.model_name}_{args.encoder_name}_{args.task}_{args.model_output_class}_artifacts_{args.frame_size}_duplicate_{args.batch_size*args.accumulation_steps}batch_{args.pooling_method}_fold{args.fold_num}_{args.train_layer}_lr{args.lr}_train'
    wandb.run.save()
...
#                 best_thresholds = current_thresholds
                ...
                checkpoint_asvl(args.seed_num, args.batch_size*args.accumulation_steps, args.version, args.frame_num, args.frame_size, 
                           ...
                           args.pooling_method, args.fold_num, args.lr, 
