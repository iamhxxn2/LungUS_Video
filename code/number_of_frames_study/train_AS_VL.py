...
from models_ML3_v7 import *
from models_ML3_v8 import *
from models_ML3_v9 import *
from models_ML3_v10 import *
...
#             param.requires_grad = True
    ...
    if args.model_name == "LUVM":
        ...
        if args.model_version == 'v1':
            ...
            model = MedVidNet_multi_attn_conv2(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v4':
            model = MedVidNet_multi_attn_conv3(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v4_':
            model = MedVidNet_multi_attn_conv3_(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v4__':
            model = MedVidNet_multi_attn_conv3__(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v4___':
            model = MedVidNet_multi_attn_conv3___(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v4____':
            model = MedVidNet_multi_attn_conv3____(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v4_____':
            model = MedVidNet_multi_attn_conv3_____(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v5':
            model = MedVidNet_multi_attn_conv4(encoder, args.num_heads, pooling_method = args.pooling_method, kernel_width = args.kernel_width)
        elif args.model_version == 'v6':
            model = MedVidNet_multi_attn_conv5(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v7':
            model = MedVidNet_multi_attn_conv6(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v8':
            model = MedVidNet_multi_attn_conv7(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v9':
            model = MedVidNet_cross_attn1(encoder, args.num_heads, pooling_method = args.pooling_method)
        elif args.model_version == 'v10':
            model = MedVidNet_cross_attn2(encoder, args.num_heads, pooling_method = args.pooling_method)
